...
const Testimonial = () => {
    ...
    const testimonials = [
        { 
          ...
          testimonial: "CarRental made my business trip seamless. The booking process was quick, and the car was in perfect condition." 
        },
        { 
          name: "Michael Lee", 
          location: "Toronto, Canada", 
          image: assets.testimonial_image_2, 
          testimonial: "I’ve tried other services, but CarRental stands out for its reliability and outstanding customer support." 
        },
      ];
